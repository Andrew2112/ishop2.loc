            ...
            <div class="col-md-12">
                <div class="product-one cart">
                    ...
                    <div class="col-md-6 account-left">
                        <?php //debug($_SESSION)?>
                        <form action="cart/checkout" method="post" role="form" data-toggle="validator">
                            ...
                            <div class="form-group has-feedback">
                                ...
                                <input type="password" name="password" class="form-control" id="password" placeholder="Пароль" value="<?= isset($_SESSION['form_data']['password']) ? $_SESSION['form_data']['password']: '' ?>" data-error="Пароль должен быть не менее 6-ти символов" data-minlength="6" required>
                                <span class="glyphicon form-control-feedback" aria-hidden="true"></span>
