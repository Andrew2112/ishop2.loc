                ...
                <form action="<?=ADMIN;?>/product/edit" method="post" data-toggle="validator">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="editor2" cols="80" rows="10"><?=$product->description;?></textarea>
                        </div>
                        ...
                        <?php new \app\widget\filter\Filter($filter, WWW . '/filter/admin_filter_tpl.php'); ?>
                        <div class="form-group">
                            <div class="col-md-4">
