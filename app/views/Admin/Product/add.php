                ...
                <form action="<?=ADMIN;?>/product/add" method="post" data-toggle="validator" id="add">
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="editor2" cols="80" rows="10"><?php isset($_SESSION['form_data']['description']) ? $_SESSION['form_data']['description'] : null; ?></textarea>
                        </div>
                        ...
                        <?php new \app\widget\filter\Filter(null, WWW . '/filter/admin_filter_tpl.php'); ?>
